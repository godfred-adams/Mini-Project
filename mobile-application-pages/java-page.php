...
<section class="heading">
    <h3>Java</h3>
    <p> <a href="../homepage">home >></a><a href="../courses">courses >></a> <a href="../coursespage/mobile">Mobile Appilaction >></a> >> Java</p>
</section>
...
<section class="main-videos">
    ...
    <div>
        <iframe src="https://www.youtube.com/embed/fis26HvvDII" title="Android Development for Beginners - Full Course" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <p>Module 1</p>
    </div>
    <div>
        <iframe src="https://www.youtube.com/embed/tZvjSl9dswg" title="Android App Development in Java All-in-One Tutorial Series (4 HOURS!)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <p>Module 2</p>
    </div>
