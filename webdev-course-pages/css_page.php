...
<section class="heading">
    <h3>CSS 3</h3>
    <p> <a href="../homepage">home >></a><a href="../courses">courses >></a> <a href="../coursespage/webdev">web development >></a> CSS 3</p>
</section>
...
<section class="main-videos">
    ...
    <div>
        <iframe src="https://www.youtube.com/embed/1Rs2ND1ryYc" title="CSS Tutorial - Zero to Hero (Complete Course)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <p>Module 1</p>
    </div>

    <div>
        <iframe src="https://www.youtube.com/embed/OXGznpKZ_sA" title="CSS Tutorial – Full Course for Beginners" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <p>Module 2</p>
    </div>

    <div>
        <iframe src="https://www.youtube.com/embed/J5KxiOnIrKg" title="CSS Full Course | CSS Tutorial For Beginners | CSS Interview Questions And Answers | Simplilearn" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <p>Module 3</p>
    </div>
