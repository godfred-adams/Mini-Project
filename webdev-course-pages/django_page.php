...
<head>
    ...
    <title>Let's-Learn | Django</title>
...
<section class="heading">
    <h3>Django</h3>
    <p> <a href="../homepage">home >></a><a href="../courses">courses >></a> <a href="../coursespage/webdev">web development >></a> Django</p>
</section>
...
<section class="main-videos">
    ...
    <div>
        <iframe src="https://www.youtube.com/embed/F5mRW0jo-U4" title="Python Django Web Framework - Full Course for Beginners" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <p>Module 1</p>
    </div>
    <div>
        <iframe src="https://www.youtube.com/embed/rHux0gMZ3Eg" title="Python Django Tutorial for Beginners" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <p>Module 2</p>
    </div>
