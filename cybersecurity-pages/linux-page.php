...
<head>
    ...
    <title>Let's-Learn | Introduction To Linux</title>
...
<section class="heading">
    ...
    <p> <a href="../homepage">home >></a><a href="../courses">courses >></a><a href="../coursespage/cybersecurity">Cybersecurity >></a> Introduction to Linux</p>
</section>
...
<section class="main-videos">
    ...
    <div>
        <iframe src="https://www.youtube.com/embed/Wgi-OfbP2Gw" title="Linux Full Course In 5 Hours | Linux Tutorial For Beginners | Linux Training | Edureka" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <p>Module 1</p>
    </div>
    
    <div>
        <iframe src="https://www.youtube.com/embed/bz0ZCUv5rYo" title="Linux Full Course - 11 Hours [2023]  | Linux Tutorial For Beginners | Linux Training | Edureka" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <p>Module 2</p>
    </div>

    <div>
        <iframe width="885" height="498" src="https://www.youtube.com/embed/lZAoFs75_cs" title="Linux for Ethical Hackers (Kali Linux Tutorial)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <p>Module 3</p>
    </div>
