...
<head>
    ...
    <title>Let's-Learn | Mobile Application</title>
...
<section class="heading">
    ...
    <p> <a href="../homepage">home >></a><a href="../courses">courses >></a> mobile application </p>
</section>
...
<section class="course-2">
    ...
    <div class="box">
        <div class="image">
            <img src="../images/courses/flutter.png" alt="flutter-icon">
        </div>
        <div class="content">
            <span>course 1</span>
            <h3>Flutter</h3>
            ...
            <a href="../mobile-application-pages/flutter-page" class="btn">start course</a>
            <div class="icons">
                <a href="#"> <i class="fas fa-book"></i> 11 modules </a>
    ...
    <div class="box">
        <div class="image">
            <img src="../images/courses/java.png" alt="java-icon">
        </div>
        <div class="content">
            <span>course 2</span>
            <h3>Java</h3>
            <p>Java is a multi-platform, object-oriented, and network-centric language that can be used as a platform in itself.</p>
            <a href="../mobile-application-pages/java-page" class="btn">start course</a>
            <div class="icons">
                <a href="#"> <i class="fas fa-book"></i> 2 modules </a>
                <a href="#"> <i class="fas fa-clock"></i> 15 hours </a>
            </div>
        </div>
    </div>
    ...
    <div class="box">
        <div class="image">
            <img src="../images/courses/swift.png" alt="swift-icon">
        </div>
        <div class="content">
            <span>course 3</span>
            <h3>Swift</h3>
            ...
            <a href="../mobile-application-pages/swift-page" class="btn">start course</a>
            <div class="icons">
